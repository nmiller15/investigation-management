DROP VIEW IF EXISTS v_contacts CASCADE;

ALTER TABLE contacts
ALTER COLUMN mobile_phone SET DATA TYPE VARCHAR(50),
ALTER COLUMN work_phone SET DATA TYPE VARCHAR(50),
ALTER COLUMN home_phone SET DATA TYPE VARCHAR(50);
